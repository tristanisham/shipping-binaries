/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: c1fc460dc8a39f31bf16e438a95165e1)
...
type AiSearchMultiChatCompletionsResponse =
  & Omit<AiSearchChatCompletionsResponse, "chunks">
  & {
    chunks: AiSearchMultiSearchChunk[];
    errors?: AiSearchMultiSearchError[];
  };
