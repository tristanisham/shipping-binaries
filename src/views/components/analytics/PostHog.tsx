...
// Public analytics intentionally excludes account and management pages. Their
// meaningful actions are captured server-side, while their forms and editor
// interactions should not influence reader engagement or Web Analytics.
const privatePathnames = /^\/(?:admin(?:\/|$)|login$|logout$|signup$|forgot-password$|reset-password$|invite$)/;
