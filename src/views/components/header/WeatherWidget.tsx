...
(() => {
  ...
  fetch("/api/weather", { headers: { Accept: "application/json" } })
    ...
    .then((weather) => {
      ...
      icon.setAttribute("href", "#weather-" + getIconName(weather));
...
export const WeatherWidget: FC = () => {
  return (
    <div
      ...
      aria-live="polite"
      class="m-4 flex items-center gap-1 text-amber-50 dark:text-mist-600"
      id="weather-widget"
    >
      <svg
        aria-hidden="true"
        ...
        viewBox="0 0 24 24"
      >
        <use data-weather-icon href="#weather-cloud" />
        <defs>
          <symbol id="weather-cloud" viewBox="0 0 24 24">
            <path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" />
          </symbol>
          <symbol id="weather-cloud-sun" viewBox="0 0 24 24">
            <path d="M12 2v2" />
          ...
          <symbol id="weather-cloud-moon" viewBox="0 0 24 24">
          ...
          <symbol id="weather-cloud-rain" viewBox="0 0 24 24">
            <path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" />
            <path d="M16 14v6" />
            <path d="M8 14v6" />
            <path d="M12 16v6" />
          </symbol>
          <symbol id="weather-cloud-lightning" viewBox="0 0 24 24">
            <path d="M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973" />
            <path d="m13 12-3 5h4l-3 5" />
          </symbol>
          <symbol id="weather-cloud-snow" viewBox="0 0 24 24">
            <path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" />
            <path d="M8 15h.01" />
            <path d="M8 19h.01" />
            <path d="M12 17h.01" />
          ...
          <symbol id="weather-cloud-fog" viewBox="0 0 24 24">
            <path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" />
            <path d="M16 17H7" />
            <path d="M17 21H9" />
          </symbol>
          <symbol id="weather-sun" viewBox="0 0 24 24">
          ...
          <symbol id="weather-moon" viewBox="0 0 24 24">
