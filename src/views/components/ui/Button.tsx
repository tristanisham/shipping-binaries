  ...
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium shadow-xs outline-none transition-all focus-visible:ring-[3px] focus-visible:ring-chocolate-500/30 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-chocolate-400/30 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        default:
          "bg-burgundy-700 text-burgundy-50 hover:bg-burgundy-600 dark:bg-burgundy-400 dark:text-burgundy-950 dark:hover:bg-burgundy-300",
        ...
        danger:
          "bg-burgundy-700 text-amber-50 hover:bg-burgundy-600 dark:bg-burgundy-400 dark:text-amber-50 dark:hover:bg-burgundy-300",
        outline:
          "border border-burgundy-700 bg-transparent text-burgundy-800 hover:bg-burgundy-100 dark:border-burgundy-300 dark:text-burgundy-200 dark:hover:bg-burgundy-300/20",
